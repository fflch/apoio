...
<fieldset>
    <legend>
        Gerenciamento de Institui&ccedil;&otilde;es
    </legend>
...
<!--			<option value="instituicao">Institui&ccedil;&atilde;o</option>-->
		</select>
		...
		<table cellspacing="0" id="listadados">
			...
			<thead>
				<tr>
					...
					<th scope="col">Institui&ccedil;&atilde;o</th>
